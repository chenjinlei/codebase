package com.intelli.qingfeng.service;

import com.intelli.qingfeng.receiver.AutoUpdateReceiver;
import com.intelli.qingfeng.util.ContextUtil;
	...
	private void updateWeather() {
		...
		HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
			...
			public void onFinish(String response) {
				...
				Utility.handleWeatherResponse(ContextUtil.getContext(), response);
			}
