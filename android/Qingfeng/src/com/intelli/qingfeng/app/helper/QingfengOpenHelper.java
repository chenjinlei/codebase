package com.intelli.qingfeng.app.helper;
...
public class QingfengOpenHelper extends SQLiteOpenHelper {
	...
	public QingfengOpenHelper(Context context, String name, CursorFactory factory, int version) {
